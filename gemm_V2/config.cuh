...
struct GemmConfig
{
  ...
  static constexpr uint32_t shared_bytes  = ((As_bytes + Bs_bytes) * bk_stages) + smem_overhead;
  ...
  static constexpr uint32_t ld_bytes = BK * sizeof(nv_bfloat16);
