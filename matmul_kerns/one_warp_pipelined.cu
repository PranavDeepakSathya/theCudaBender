...

{
  ...
  for (int wk = 0; wk < BK; wk +=mma_k*BK_stages)
  {
    ...
    asm volatile(
        ...
        : "r"(ra_1_0_0), "r"(ra_1_0_1), "r"(ra_1_0_2), "r"(ra_1_0_3),
          "r"(rb_1_0_0), "r"(rb_1_0_1),
          "f"(rc_0_0_0), "f"(rc_0_0_1), "f"(rc_0_0_2), "f"(rc_0_0_3))
    );
    //m_acc=0,n_acc=1
    ...
    asm volatile(
        ...
        : "r"(ra_1_1_0), "r"(ra_1_1_1), "r"(ra_1_1_2), "r"(ra_1_0_3),
          "r"(rb_1_0_0), "r"(rb_1_0_1),
          "f"(rc_1_0_0), "f"(rc_1_0_1), "f"(rc_1_0_2), "f"(rc_1_0_3))
    );
    //m_acc=1,n_acc=1
    asm volatile(
        ...
        "{%8, %9}, "
        "{%10, %11, %12, %13};\n"
        : "=f"(rc_1_1_0), "=f"(rc_1_1_1), "=f"(rc_1_1_2), "=f"(rc_1_1_3)
        : "r"(ra_1_1_0), "r"(ra_1_1_1), "r"(ra_1_1_2), "r"(ra_1_1_3),
          "r"(rb_1_1_0), "r"(rb_1_1_1),
          "f"(rc_1_1_0), "f"(rc_1_1_1), "f"(rc_1_1_2), "f"(rc_1_1_3))
    );
    //m_acc=0,n_acc=2
    asm volatile(
        ...
        "{%8, %9}, "
        "{%10, %11, %12, %13};\n"
        : "=f"(rc_1_2_0), "=f"(rc_1_2_1), "=f"(rc_1_2_2), "=f"(rc_1_2_3)
        : "r"(ra_1_1_0), "r"(ra_1_1_1), "r"(ra_1_1_2), "r"(ra_1_1_3),
          "r"(rb_1_2_0), "r"(rb_1_2_1),
          "f"(rc_1_2_0), "f"(rc_1_2_1), "f"(rc_1_2_2), "f"(rc_1_2_3))
    );
    ...
    asm volatile(
        ...
        "{%8, %9}, "
        "{%10, %11, %12, %13};\n"
        : "=f"(rc_1_3_0), "=f"(rc_1_3_1), "=f"(rc_1_3_2), "=f"(rc_1_3_3)
        : "r"(ra_1_1_0), "r"(ra_1_1_1), "r"(ra_1_1_2), "r"(ra_1_1_3),
          "r"(rb_1_3_0), "r"(rb_1_3_1),
          "f"(rc_1_3_0), "f"(rc_1_3_1), "f"(rc_1_3_2), "f"(rc_1_3_3))
    );
    ...
    asm volatile(
        ...
        "{%10, %11, %12, %13};\n"
        : "=f"(rc_1_1_0), "=f"(rc_1_1_1), "=f"(rc_1_1_2), "=f"(rc_1_1_3)
        : "r"(ra_0_1_0), "r"(ra_0_1_1), "r"(ra_0_1_2), "r"(ra_0_1_3),
          "r"(rb_0_1_0), "r"(rb_0_1_1),
          "f"(rc_1_1_0), "f"(rc_1_1_1), "f"(rc_1_1_2), "f"(rc_1_1_3))
    );
    //m_acc=0,n_acc=2
