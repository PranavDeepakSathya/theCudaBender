...
print("\n--- IKP Trace Profiling ---")
_ = ext.gemm(A,B)  # profiled run
ext.dump_trace("matmul_prefetch_v3_trace.json")
print("Trace written to matmul_prefetch_v3_trace.json")
print("Summary written to matmul_prefetch_v3_trace_summary.json")
